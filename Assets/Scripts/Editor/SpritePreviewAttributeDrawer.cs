...
{
    private const float k_spacing = 5f; // 필드와 아이콘 간의 여백
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        var spriteRect = new Rect
        {
            ...
            y = position.y + singleLineHeight + k_spacing,
            width = previewSize,
            height = previewSize,
        };
    ...
    {
        return EditorGUIUtility.singleLineHeight + (attribute as SpritePreviewAttribute).Size + k_spacing;
    }
}
